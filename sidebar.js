...
function renderChrome(activePage) {
  ...
  const nav = [
    { key: "dashboard", label: "Dashboard", href: "dashboard_freelancer.html", icon: "M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" },
    { key: "browse", label: "Browse Jobs", href: "browse_jobs.html", icon: "M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" },
    { key: "applications", label: "My Applications", href: "my_applications.html", icon: "M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" },
    { key: "messages", label: "Messages", href: "messages.html", icon: "M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.86 9.86 0 01-4-.8L3 20l1.3-3.9A7.9 7.9 0 013 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" },
    { key: "portfolio", label: "Portfolio", href: "portfolio.html", icon: "M3 7a2 2 0 012-2h4l2 2h8a2 2 0 012 2v8a2 2 0 01-2 2H5a2 2 0 01-2-2V7z" },
    { key: "earnings", label: "Earnings", href: "earnings.html", icon: "M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V6m0 10v2m9-8a9 9 0 11-18 0 9 9 0 0118 0z" },
    { key: "profile", label: "Profile", href: "profile.html", icon: "M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" },
    { key: "settings", label: "Settings", href: "settings.html", icon: "M10.325 4.317a1 1 0 011.35-.936l.894.335a1 1 0 00.836-.06l.82-.474a1 1 0 011.214.163l.633.633a1 1 0 00.727.29h.947a1 1 0 011 1v.947a1 1 0 00.29.727l.633.633a1 1 0 01.163 1.214l-.474.82a1 1 0 00-.06.836l.335.894a1 1 0 01-.936 1.35l-.947.164a1 1 0 00-.727.573l-.42.868a1 1 0 01-1.117.51l-.918-.245a1 1 0 00-.86.14l-.79.55a1 1 0 01-1.19 0l-.79-.55a1 1 0 00-.86-.14l-.918.245a1 1 0 01-1.117-.51l-.42-.868a1 1 0 00-.727-.573l-.947-.164a1 1 0 01-.936-1.35l.335-.894a1 1 0 00-.06-.836l-.474-.82a1 1 0 01.163-1.214l.633-.633a1 1 0 00.29-.727V6.32a1 1 0 011-1h.947a1 1 0 00.727-.29l.633-.633a1 1 0 011.214-.163l.82.474a1 1 0 00.836.06l.894-.335z" }
  ];
  ...
  sidebar.innerHTML = `
    ...
    <a class="fm-nav-link fm-logout" href="index.html">
