...
<head>
    ...
    <style>
        ...
        a[href="Admin/adminlogin.php"]:hover {
            color: #f472b6 !important;
            text-decoration: underline !important;
        }
    </style>
        ...
        <div class="w-full max-w-md mx-auto space-y-6">
            ...
            <div class="text-center space-y-2 pt-2 text-xs">
                ...
                <p class="text-gray-500">
                    ...
                    <a href="Admin/adminlogin.php" class="text-cyan-400 hover:underline font-medium" style="color: #22d3ee !important; font-weight: 600 !important;">
